        ...
        <form method="POST" action="{{ route('produk.update', $produk->id) }}">
            ...
            <div class="form-grid">
                ...
                <div class="form-group" style="position: relative;">
                    ...
                    <a href="{{ route('kategori.index', ['back' => 'edit', 'id' => $produk->id]) }}" class="btn btn-outline btn-sm" style="position: absolute; right: 0; top: -6px; padding: 3px 8px; font-size: 11px; line-height: 1.2;">
